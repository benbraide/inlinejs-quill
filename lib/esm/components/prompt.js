...
export class QuillPromptElement extends CustomElement {
    constructor() {
        super();
    ...
    HandleElementScopeCreated_(_a, postAttributesCallback) {
        ...
        this.nativeElement_.addEventListener('submit', (e) => {
            ...
            const quill = (this.quill || FindAncestor(this, ancestor => ('AddPrompt' in ancestor)));
        ...
        super.HandleElementScopeCreated_(Object.assign({ scope }, rest), () => {
            ...
            (_b = (this.quill || FindAncestor(this, ancestor => ('AddPrompt' in ancestor)))) === null || _b === void 0 ? void 0 : _b.AddPrompt(this);
        ...
        this.addEventListener('click', (e) => {
            ...
            if (this.toggle) {
                ...
                (_a = (this.quill || FindAncestor(this, ancestor => ('AddPrompt' in ancestor)))) === null || _a === void 0 ? void 0 : _a.WaitInstance().then(instance => instance === null || instance === void 0 ? void 0 : instance.focus());
            }
