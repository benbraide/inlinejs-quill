import { FindComponentById, AddDirectiveHandler, CreateDirectiveHandlerCallback, //['link', 'image', 'video', 'color', 'background', 'font', 'indent']
GetGlobal, JournalError, BindEvent, ResolveOptions, IsObject, EvaluateLater } from "@benbraide/inlinejs";
export const QuillDirectiveHandler = CreateDirectiveHandlerCallback('quill', ({ componentId, component, contextElement, expression, argKey, argOptions }) => {
    ...
    EvaluateLater({ componentId, contextElement, expression })((value) => {
        ...
        if (IsObject(value)) {
            ...
            IsObject(value.modules) && (state.modules = Object.assign(Object.assign({}, state.modules), value.modules));
            ...
            !options.manual && ((_b = (_a = FindComponentById(componentId)) === null || _a === void 0 ? void 0 : _a.FindElementScope(contextElement)) === null || _b === void 0 ? void 0 : _b.AddPostProcessCallback(() => state.dev.bind()));
        }
    });
});
