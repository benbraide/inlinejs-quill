...
exports.QuillDirectiveHandler = (0, inlinejs_1.CreateDirectiveHandlerCallback)(QuillDirectiveName, ({ componentId, component, contextElement, expression, argKey, argOptions }) => {
    ...
    let id = resolvedComponent.GenerateUniqueId(`${QuillDirectiveName}_proxy_`), options = (0, inlinejs_1.ResolveOptions)({
        options: {
            manual: false,
            readonly: false,
            snow: false,
    ...
    let setActive = (name, value) => {
        ...
        if (name in details.toolbar && value != details.toolbar[name].active) {
            ...
            (0, inlinejs_1.AddChanges)('set', `${id}.${name}.active`, 'active', (_a = (0, inlinejs_1.FindComponentById)(componentId)) === null || _a === void 0 ? void 0 : _a.GetBackend().changes);
        }
    };
    let onEditorChange = () => {
