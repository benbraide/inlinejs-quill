...
exports.QuillDirectiveHandler = (0, inlinejs_1.CreateDirectiveHandlerCallback)(QuillDirectiveName, ({ componentId, component, contextElement, expression, argKey, argOptions }) => {
    ...
    if (!resolvedComponent || !elementScope) {
        return (0, inlinejs_1.JournalError)('Failed to retrieve element scope.', `InlineJS.${QuillDirectiveName}`, contextElement);
    }
    ...
    if (groupKey) {
        ...
        let addToolbarItem = (name, match, action) => {
            ...
            let toolbarEntryProxy = (0, inlinejs_1.CreateInplaceProxy)((0, inlinejs_1.BuildGetterProxyOptions)({
                getter: (prop) => {
                    var _a, _b;
                    ...
                    if (prop === 'parent') {
                        return (contextElement.parentElement ? (_b = (0, inlinejs_1.FindComponentById)(componentId)) === null || _b === void 0 ? void 0 : _b.FindElementLocalValue(contextElement.parentElement, localKey, true) : null);
                    }
                },
            ...
            if (match) { //Bind listener
                contextElement.addEventListener('click', () => {
                    ...
                    (Array.isArray(details.toolbar[name]) ? details.toolbar[name] : [details.toolbar[name]]).forEach((item) => {
                        ...
                        (0, inlinejs_1.AddChanges)('set', `${item.id}.active`, 'active', (_a = (0, inlinejs_1.FindComponentById)(componentId)) === null || _a === void 0 ? void 0 : _a.GetBackend().changes);
                    });
                });
            }
    ...
    let setActive = (name, value) => {
        var _a;
        let changes = (_a = (0, inlinejs_1.FindComponentById)(componentId)) === null || _a === void 0 ? void 0 : _a.GetBackend().changes;
        if (changes && details.toolbar.hasOwnProperty(name) && value != getFirstToolbarEntry(details.toolbar[name]).active) {
            ...
            (Array.isArray(entry) ? entry : [entry]).forEach(item => {
                item.active = value;
                (0, inlinejs_1.AddChanges)('set', `${item.id}.active`, 'active', changes);
            });
        }
    };
    let onEditorChange = () => {
