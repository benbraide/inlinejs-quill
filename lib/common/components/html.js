...
exports.QuillHtmlElementCompact = exports.QuillHtmlElement = void 0;
const inlinejs_1 = require("@benbraide/inlinejs");
const inlinejs_element_1 = require("@benbraide/inlinejs-element");
class QuillHtmlElement extends inlinejs_element_1.CustomElement {
    constructor() {
        super();
...
exports.QuillHtmlElement = QuillHtmlElement;
function QuillHtmlElementCompact() {
    (0, inlinejs_element_1.RegisterCustomElement)(QuillHtmlElement, 'quill-html');
}
exports.QuillHtmlElementCompact = QuillHtmlElementCompact;
