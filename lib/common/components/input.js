...
exports.QuillInputElementCompact = exports.QuillInputElement = void 0;
const inlinejs_1 = require("@benbraide/inlinejs");
const inlinejs_element_1 = require("@benbraide/inlinejs-element");
class QuillInputElement extends inlinejs_element_1.CustomElement {
    constructor() {
        super();
    ...
    HandleElementScopeCreated_(_a, postAttributesCallback) {
        ...
        (_b = (0, inlinejs_1.FindAncestor)(this, ancestor => ('AddQuillInput' in ancestor))) === null || _b === void 0 ? void 0 : _b.AddQuillInput(this);
    ...
    CreateStyleElement_() {
        ...
        QuillInputElement.className = `quill-input-${(0, inlinejs_1.RandomString)(8)}`;
    ...
    CreateInputElements_() {
        ...
        (this.expandedItems_ || ['text']).forEach((item) => {
            ...
            input.addEventListener((isFile ? 'change' : 'input'), () => {
                ...
                this.onvaluechange && (0, inlinejs_1.EvaluateLater)({
...
exports.QuillInputElement = QuillInputElement;
function QuillInputElementCompact() {
    (0, inlinejs_element_1.RegisterCustomElement)(QuillInputElement, 'quill-input');
}
exports.QuillInputElementCompact = QuillInputElementCompact;
